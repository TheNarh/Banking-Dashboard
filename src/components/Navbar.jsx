function Navbar() {
  return (
    <nav className="bg-white shadow-sm mb-2 rounded-2xl px-6 py-4 flex justify-between items-center">
      {/* Logo / Brand */}
      <div className="flex items-center gap-2">
        <div className="bg-blue-600 text-white font-bold text-lg px-3 py-1 rounded-lg">
          GB
        </div>
        <span className="text-xl font-bold text-gray-800">GhanaBank</span>
      </div>
